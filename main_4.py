...
class VkBotServer:
            ...
            if self.event.type == VkEventType.MESSAGE_NEW and self.event.to_me:
                ...
                if self.event.to_me:
                    ...
                    if request == "start" and not self.vk_db.user_exists(self.user_id):
                        ...
                        self.get_and_show_next_candidate()
                        ...
                        self.add_mark(True, message)
                        self.get_and_show_next_candidate()

                    elif request == "👎":
                        message = "{} {} добавлен(a) в Чёрный список"
                        self.add_mark(False, message)
                        self.get_and_show_next_candidate()
    ...
    def add_mark(self, mark, message):
        id = self.candidate.vk_id
    ...
    def get_and_show_next_candidate(self):
        self.candidate = self.vk_db.get_random_none_candidate(self.user_id)
        ...
        self.show_candidate(photo_urls, message=message)
    ...
    def show_candidate(self, photo_urls, message=''):
